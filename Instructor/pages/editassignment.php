...
<body id="page-top">
    ...
    if(isset($_REQUEST['assignmentEditBtn'])){
        ...
        if(($_REQUEST['assignment_name'] == "")  || ($_REQUEST['assignment_description'] == "") || 
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class=" form-outline mb-4">
                            ...
                            value="<?php if (isset($row['assignment_name']))
                        ...
                        <input type="hidden" id="documentlocation" name="documentlocation" class="form-control" 
                                    value="<?php if(isset($row['doc_location'])) echo $row['doc_location']; ?>" />
                            <a class="btn btn-outline-danger mb-2" href="<?php if(isset($row['doc_location'])) echo $row['doc_location']; ?>" download>Download Task</a><br>
                            <label for="assignmentdoc">Upload Assignment Document</label>
                            <input type="file" class="form-control-file" id="assignmentdoc" name="assignmentdoc"
