            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Preview Blog Post</h1>

                    </div>
                    <?php
                    if (isset($_REQUEST['previewblog'])) {
                        $post_id = $_REQUEST['id'];
                        ...
                        if ($result && $result->num_rows > 0) {
                            ...
                            <div class="course-meta-area">
                                <div class="row">
                                    ...
                                    <a  href ="approvepost.php"class="btn btn-danger btn-lg btn-circle" style="position: fixed;bottom: 10px;right: 20px;margin-bottom: 80px;">
