...
<head>
    ...
    <title>Instructors | Cloud Learner</title>
                ...
                <div class="container-fluid">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo '<tr>
                                ...
                                <button type="submit" name="viewinstructor" value="Viewinstructor" class="btn btn-primary btn-circle">
                    ...
                    echo '</tbody>
                        ...
                        if(isset($_REQUEST['delete'])){
                            $sql = "DELETE FROM insstructor WHERE instructor_id={$_REQUEST['id']}";
                    ...
                    <div>
                        <a href="addinstructor.php" class="btn btn-primary btn-circle btn-lg "
